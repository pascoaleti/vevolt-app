...
function materialize(base, entry, localeKey) {
  return {
    ...
    imageAlt: entry.imageAlt || editorialImageAlts[localeKey][base.slug] || base.imageAlt,
...
const en = [
  ...
  {
    slug: "condominium-ev-charging-management", title: "Condominium EV charging management: organizing chargers and residents", description: "A practical workflow for property managers to organize residents, shared chargers, schedules, manual session records and cost allocation.", keyword: "condominium EV charging management", imageAlt: "Property manager organizes residents and shared EV chargers", lead: "Condominium charging management turns an approved technical setup into a clear daily process for residents and property managers. Electrical design remains with qualified professionals; the app organizes participation and use.",
    sectionHeadings: ["Map the approved operation", "Connect people, schedules and sessions", "Use VeVolt Condo within its limits"],
    paragraphs: ["List authorized residents, private chargers, operating hours and the person responsible for reviewing records. The schedule should reflect the capacity and rules already established by the building.", "A shared view should show who can book, which charger is reserved and how each completed session is recorded. VeVolt Condo supports up to 50 participants and 10 chargers; invited residents do not need Premium.", "VeVolt organizes schedules, sessions, manual consumption and manual cost allocation. It does not control hardware, meter energy, bill residents, run OCPP or perform load balancing."],
    bullets: ["Authorized participants", "Approved chargers", "Conflict-free booking", "Manual session records", "Monthly review"],
    faqs: [["Does VeVolt replace an electrical assessment?", "No. Design, installation, metering and safety remain external professional responsibilities."], ["Do invited residents need Premium?", "No. Premium and Condo are separate subscriptions."], ["Is a trial available?", "Eligible new customers can try the monthly Condo plan free for 15 days through Google Play."]],
    contextLinks: [{href:"/en/condo",label:"Explore VeVolt Condo"},{href:"/en/blog/electric-car-charger-in-condominium",label:"Read the condominium charging pillar guide"},{href:"/en/blog/app-to-book-condominium-ev-charger",label:"See how charger booking works"}],
  },
  {
    slug: "allocate-ev-charging-costs-condominium", title: "How to allocate EV charging costs in a condominium", description: "Define data sources, rates, review steps and manual records for fair and transparent shared EV charging cost allocation.", keyword: "allocate EV charging costs condominium", imageAlt: "Property manager reviews EV charging consumption and cost allocation", lead: "Transparent allocation starts with a known source for consumption, an agreed rate and a consistent closing period. VeVolt can organize manually entered records, but it does not meter or bill energy.",
    sectionHeadings: ["Define the source and formula", "Review records before charging residents", "Keep an auditable closing process"],
    paragraphs: ["Document where session consumption comes from, which energy rate applies and how losses or other approved costs are handled. The method should be reproducible by the building administration.", "Check missing sessions, duplicate values, units and discrepancies against the building's chosen source. VeVolt records are operational support, not an electricity invoice.", "Keep supporting readings and approvals in the condominium's official records. The app helps consolidate manually entered sessions for monthly review."],
    bullets: ["Closing period", "Consumption source", "Approved rate", "Review owner", "Documented adjustments"],
    faqs: [["Does VeVolt read a meter?", "No. Consumption and costs are entered manually."], ["Does VeVolt collect payment?", "No. Billing and payment happen outside the app."], ["Who chooses the rate?", "The condominium must define and validate its method for the local context."]],
    contextLinks: [{href:"/en/condo",label:"Organize manual allocation with VeVolt Condo"},{href:"/en/blog/electric-car-charger-in-condominium",label:"Read the pillar guide"},{href:"/en/blog/condominium-ev-charging-management",label:"Structure the complete management workflow"}],
  },
  {
    slug: "shared-ev-charger-condominium-rules", title: "Shared EV charger in a condominium: rules, booking and usage", description: "Create practical booking, delay, session and responsibility rules for residents sharing an EV charger.", keyword: "shared EV charger condominium rules", imageAlt: "Residents check shared EV charger rules and booking schedule", lead: "A shared charger works best when every resident sees the same availability and understands booking duration, tolerance, session records and bay-release rules.",
    sectionHeadings: ["Define access and responsibilities", "Build a workable booking policy", "Review conflicts and adjust"],
    paragraphs: ["Identify authorized users, approved vehicles and who handles incidents. App membership does not replace physical access controls for the equipment or parking area.", "Set booking length, cancellation notice, tolerance and maintenance blocks. Connect each completed booking to a manual session record so monthly review has context.", "Track disputed time slots and repeated overruns. VeVolt does not physically block the charger outside a reservation; consistent rules remain essential."],
    bullets: ["Booking duration", "Cancellation notice", "Late-arrival tolerance", "Maintenance blocks", "Session completion"],
    faqs: [["Can VeVolt lock a charger outside a booking?", "No. It organizes the schedule without controlling hardware."], ["How many chargers can a hub include?", "Up to 10 private chargers."], ["Can residents see available times?", "Yes. Invited participants use the shared schedule to avoid overlapping reservations."]],
    contextLinks: [{href:"/en/condo",label:"Manage bookings with VeVolt Condo"},{href:"/en/blog/electric-car-charger-in-condominium",label:"Read the pillar guide"},{href:"/en/blog/allocate-ev-charging-costs-condominium",label:"Plan manual cost allocation"}],
  },
  {
    slug: "app-to-book-condominium-ev-charger", title: "App to book an EV charger in a condominium", description: "Organize residents, conflict-free charging times, sessions and manual consumption records in one private condominium hub.", keyword: "app to book condominium EV charger", imageAlt: "VeVolt Condo app displays a shared EV charger booking schedule", lead: "A booking app replaces scattered messages with one view of residents, chargers and time slots. It organizes access to the schedule without connecting to or controlling the electrical equipment.",
    sectionHeadings: ["Choose a workflow, not just a calendar", "How VeVolt Condo booking works", "Know the product boundaries"],
    paragraphs: ["Useful booking connects the participant, charger, start and end time, completed session and manual record. This gives property managers context for the monthly close.", "The administrator creates a hub, adds up to 10 chargers and invites up to 50 participants. Residents book available time slots and enter consumption and cost after use.", "VeVolt does not use OCPP, start charging, meter energy, bill residents or balance electrical load. Eligible new customers can try the monthly Condo plan free for 15 days on Google Play."],
    bullets: ["Private hub", "Resident invitations", "Conflict-free time slots", "Manual session records", "Monthly closing support"],
    faqs: [["Does the app work as a charger remote?", "No. It organizes bookings and records only."], ["Do invited residents pay for Premium?", "No. They join the Condo hub without Premium."], ["Is the monthly plan available with a trial?", "Eligible new customers can receive a 15-day trial through Google Play."]],
    contextLinks: [{href:"/en/condo",label:"Try VeVolt Condo"},{href:"/en/blog/electric-car-charger-in-condominium",label:"Read the complete condominium guide"},{href:"/en/blog/shared-ev-charger-condominium-rules",label:"Define shared charger rules"}],
  },
];
...
const es = [
  ...
  {
    slug: "gestion-recarga-condominios", title: "Gestión de recarga en condominios: cargadores y residentes", description: "Organiza residentes, cargadores compartidos, agenda, sesiones manuales y reparto de costos con un flujo claro.", keyword: "gestión recarga condominios", imageAlt: "Administración organiza residentes y cargadores compartidos", lead: "La gestión convierte una instalación aprobada en una rutina clara para administración y residentes. El proyecto eléctrico sigue en manos profesionales; la aplicación organiza participación y uso.", sectionHeadings: ["Mapea la operación aprobada", "Conecta personas, agenda y sesiones", "Usa VeVolt dentro de sus límites"], paragraphs: ["Lista residentes autorizados, cargadores privados, horarios y responsable de revisar registros. La agenda debe respetar las reglas técnicas del edificio.", "Una vista común muestra quién reserva, qué cargador usa y cómo registra la sesión. VeVolt Condo admite hasta 50 participantes y 10 cargadores; los invitados no necesitan Premium.", "VeVolt organiza agenda, sesiones, consumo y reparto manual. No controla equipos, no mide ni cobra energía, no ejecuta OCPP ni balancea carga."], bullets: ["Participantes", "Cargadores aprobados", "Agenda sin conflictos", "Registros manuales", "Revisión mensual"], faqs: [["¿Sustituye la evaluación eléctrica?", "No. Proyecto, instalación, medición y seguridad son externos."], ["¿Los invitados necesitan Premium?", "No."], ["¿Hay prueba gratis?", "Nuevos clientes elegibles pueden probar el plan Condo mensual durante 15 días en Google Play."]], contextLinks: [{href:"/es/condo",label:"Conoce VeVolt Condo"},{href:"/es/blog/cargador-coche-electrico-en-condominio",label:"Lee la guía principal"},{href:"/es/blog/app-agendar-cargador-condominio",label:"Consulta la agenda por aplicación"}],
  },
  {
    slug: "reparto-energia-coche-electrico-condominio", title: "Cómo repartir el costo de recarga del coche eléctrico en el condominio", description: "Define datos, tarifa, revisión y registros manuales para un reparto transparente de la recarga compartida.", keyword: "reparto energía coche eléctrico condominio", imageAlt: "Administración revisa consumo y reparto de recargas", lead: "Un reparto claro empieza por una fuente de consumo conocida, una tarifa acordada y un período de cierre. VeVolt organiza datos manuales, pero no mide ni cobra energía.", sectionHeadings: ["Define fuente y fórmula", "Revisa antes del cobro", "Conserva un cierre verificable"], paragraphs: ["Documenta el origen del consumo, la tarifa aplicada y el tratamiento de costos aprobados. El método debe poder reproducirse.", "Comprueba sesiones incompletas, duplicados y diferencias con la fuente elegida. Los registros del app apoyan la operación; no son una factura eléctrica.", "Guarda lecturas y aprobaciones en los registros oficiales del condominio. VeVolt reúne sesiones manuales para la revisión mensual."], bullets: ["Período", "Fuente de consumo", "Tarifa", "Responsable", "Ajustes documentados"], faqs: [["¿VeVolt lee el medidor?", "No."], ["¿Cobra al residente?", "No. El pago ocurre fuera del app."], ["¿Quién elige la tarifa?", "El condominio debe definir y validar su método."]], contextLinks: [{href:"/es/condo",label:"Organiza el reparto manual"},{href:"/es/blog/cargador-coche-electrico-en-condominio",label:"Lee la guía principal"},{href:"/es/blog/gestion-recarga-condominios",label:"Estructura la gestión completa"}],
  },
  {
    slug: "cargador-compartido-condominio-reglas", title: "Cargador compartido en condominio: reglas, agenda y uso", description: "Define reservas, tolerancias, sesiones y responsabilidades para reducir conflictos entre residentes.", keyword: "cargador compartido condominio reglas", imageAlt: "Residentes consultan reglas y agenda de carga compartida", lead: "Compartir funciona mejor cuando todos ven la misma disponibilidad y conocen duración, tolerancia, registro y liberación de la plaza.", sectionHeadings: ["Define acceso y responsabilidades", "Crea reglas de agenda útiles", "Revisa conflictos"], paragraphs: ["Identifica usuarios autorizados y quién atiende incidencias. Entrar al app no sustituye controles físicos.", "Define duración, cancelación, tolerancia y mantenimiento. Vincula cada reserva usada con un registro manual.", "Revisa horarios disputados y retrasos. VeVolt no bloquea físicamente el cargador fuera de la reserva."], bullets: ["Duración", "Cancelación", "Tolerancia", "Mantenimiento", "Cierre de sesión"], faqs: [["¿VeVolt bloquea el cargador?", "No. Solo organiza la agenda."], ["¿Cuántos cargadores admite?", "Hasta 10."], ["¿Evita reservas superpuestas?", "La agenda muestra horarios disponibles sin conflictos."]], contextLinks: [{href:"/es/condo",label:"Gestiona la agenda"},{href:"/es/blog/cargador-coche-electrico-en-condominio",label:"Lee la guía principal"},{href:"/es/blog/reparto-energia-coche-electrico-condominio",label:"Entiende el reparto"}],
  },
  {
    slug: "app-agendar-cargador-condominio", title: "Aplicación para agendar el cargador eléctrico del condominio", description: "Organiza residentes, horarios sin conflicto, sesiones y consumo manual en una central privada.", keyword: "app agendar cargador condominio", imageAlt: "Aplicación VeVolt Condo muestra agenda de cargador", lead: "Una aplicación de agenda sustituye mensajes dispersos por una vista común de residentes, cargadores y horarios, sin controlar el equipo eléctrico.", sectionHeadings: ["Busca un flujo completo", "Cómo funciona en VeVolt Condo", "Conoce los límites"], paragraphs: ["La agenda útil conecta participante, cargador, inicio, fin y registro manual de la sesión.", "La administración crea la central, añade hasta 10 cargadores e invita hasta 50 participantes. Los residentes reservan y registran consumo y costo.", "VeVolt no usa OCPP, no activa equipos, no mide, no cobra energía ni balancea carga. Nuevos clientes elegibles pueden probar el plan mensual durante 15 días."], bullets: ["Central privada", "Invitaciones", "Horarios sin conflicto", "Sesiones manuales", "Cierre mensual"], faqs: [["¿Funciona como control remoto?", "No."], ["¿Los invitados pagan Premium?", "No."], ["¿Existe prueba?", "Sí, para nuevos clientes elegibles del plan Condo mensual en Google Play."]], contextLinks: [{href:"/es/condo",label:"Prueba VeVolt Condo"},{href:"/es/blog/cargador-coche-electrico-en-condominio",label:"Lee la guía completa"},{href:"/es/blog/cargador-compartido-condominio-reglas",label:"Define reglas de uso"}],
  },
];
